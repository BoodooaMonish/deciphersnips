...
<div style="text-align\: center;" data-mce-style="text-align\: center;" jstcache="0"><a href=\"https\:\/\/www\.maximiles\.fr\/help\/new\" target=\"\_blank\" rel=\"noopener\" data-mce-href=\"https\:\/\/www\.maximiles\.fr\/help\/new" data-mce-selected=\"inline-boundary\" jstcache=\"0\">Support</a></div>
]]></style>
`;
...
let continueAfter = `
<style label="countdownSubmitTimer" arg\:btnID="btn_continue" arg\:timeout="15" name="respview.client.js" \$\{1\:with\=\"Q12\"\} wrap="ready"><![CDATA[
var submitBtn = $ ('#'+'\$(btnID)');
...
["timespentAllPages", timeallPages, "Adds a virtual float question which add a timespent value for all pages on the survey."],
...
["exec", "<exec>\n${0}\n</exec>", "exec Tag"],
["when", "when=\"${1|survey,started,init,virtualInit,finished,returning,verified,virtual,flow,sqlTransfer,sqlTransferInit,submit,autosaveRestored|}\"${0}", "CDATA Tag"],
...
["builder:cname", "builder:cname=\"${1:desiredcname.com}\"${0}", "The builder:cname attribute allows you to add a pre-configured CNAME to your survey."],
...
["colLegend", "colLegend=\"${1|none,both,top,bottom,group,beforeGroup|}\"${0}", "The colLegend attribute allows you to specify the placement of the column legend."],
...
["comment", "<comment>${1|Only one answer possible,Multiple answers possible|}</comment>${0}", "The comment attribute allows you to specify additional text to display beneath the question's title attribute./n/nThis is the English version"],
["commentfr", "<comment>${1|Une seule réponse possible,Plusieurs réponses possibles|}</comment>${0}", "The comment attribute allows you to specify additional text to display beneath the question's title attribute./n/nThis is the French version"],
["commentde", "<comment>${1|Nur eine Antwort möglich,Mehrere Antworten möglich|}</comment>${0}", "The comment attribute allows you to specify additional text to display beneath the question's title attribute./n/nThis is the German version"],
["commentit", "<comment>${1|Una sola risposta possibile,Sono possibili più risposte|}</comment>${0}", "The comment attribute allows you to specify additional text to display beneath the question's title attribute./n/nThis is the Italian version"],
["commentes", "<comment>${1|Una sola respuesta posible,Múltiples respuestas posibles|}</comment>${0}", "The comment attribute allows you to specify additional text to display beneath the question's title attribute./n/nThis is the Spanish version"],
["commentnl", "<comment>${1|Eén antwoord mogelijk,Meerdere antwoorden mogelijk|}</comment>${0}", "The comment attribute allows you to specify additional text to display beneath the question's title attribute./n/nThis is the Dutch version"],
["datasource", "<datasource label=\"${6:db1}\" title=\"${5:db name}\"\nfilename=\"${4:filename.txt}\"\nourKey=\"${3:source}\"\ndatasourceKey=\"${2:codeid}\"\nnormalizeKey=\"${1|none,lower|}\">${0}</datasource>", "The <datasource> element is a survey builder-friendly way of merging external data from a tab-delimited file into your survey."],
...
["title", "title=\"${1:database description}\"${0}", "Title attribute"],
...
["checkbox", "<checkbox label=\"${1:Q1}\" atleast=\"1\">\n${0}\n</checkbox><suspend/>", "The <checkbox> element represents the only multiple-selection question type available."],
...
["text", "<text label=\"${1:Q1}\" optional=\"0\" size=\"25\">${0}</text>", "The <text> element is an open-ended question type that gathers text input from participants such as descriptions, name, email, zip code, etc..."],
["textarea", "<textarea label=\"${1:Q1}\" height=\"10\" optional=\"0\" width=\"50\">${0}</textarea>", "The <textarea> element is an open-ended question type that gathers text input from participants. In contrast to the <text> element, the <textarea> element produces a multi-line input box."],
...
["radio=", "radio=\"${1:1}\"${0}", "The radio attribute is a boolean value that forces the entire column to use radio inputs instead of checkboxes."],
...
["exitmsg", "<exit cond=\"${1|qualifed,terminated,overquota|}\" ${2:timeout\=\"5\"}>${3:Thank you for taking our survey.}</exit>${0}", "The <exit> element determines what happens when a participant finishes the survey.\nDisplay a Message"],
["exit", "<exit cond=\"${1|qualifed,terminated,overquota|}\" url=\"${1:someRedirectLink}\"/>${0}", "The <exit> element determines what happens when a participant finishes the survey.\nRedirect to a URL"],
["exitredirect", "<exit cond=\"${1|qualifed,terminated,overquota|}\" ${2:timeout\=\"5\"} url=\"${3:someRedirectLink}\">${4:Exit Message after the redirect}</exit>${0}", "The <exit> element determines what happens when a participant finishes the survey.\nDisplay a Message Before Redirecting to a URL"],
...
["html", "<html label=\"${1:intro1}\" where=\"survey\">\n${0}\n</html>", "The <html> element is sometimes referred to as a survey comment and is used to display text or HTML in your survey."],
...
["cardrating:dragdrop", "cardrating:dragdrop=\"${1:0}\"${1}", "Allows participants to drag & drop of cards into buckets on desktop devices."],
["cardrating:navigation", "cardrating:navigation=\"${1:0}\"${1}", "Allows participants to navigate back and forth between cards to change their previous answers.Allows participants to navigate back and forth between cards to change their previous answers."],
["cardrating:progress", "cardrating:progress=\"${1:0}\"${1}", "Shows a progress bar below the cards."],
